...
class BiomarExitReportForm extends ConsumerStatefulWidget {
  final AllLogbook? preloadedData;
  final Future<bool> Function(Map<String, dynamic>)? onSubmit;
  const BiomarExitReportForm({super.key, this.onSubmit, this.preloadedData});

  @override
  ConsumerState<BiomarExitReportForm> createState() => _ExitReportFormState();
}

class _ExitReportFormState extends ConsumerState<BiomarExitReportForm> {
