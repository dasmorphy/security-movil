...
class DonutExpalsa extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    // porcentaje SOLO para dibujar la dona
    final pct = totalGeneral == 0 ? 0 : totalEntrada / totalGeneral;
      ...
      child: Column(
        ...
        children: [
              ...
              child: Stack(
                ...
                children: [
                  ...
                  Column(
                    ...
                    children: [
                      Text(
                        NumberFormat.compact().format(totalGeneral),
          ...
          _LegendItem(
            ...
            label: 'Salida',
            count: totalSalida,
            percentage: totalGeneral == 0 ? 0 : (totalSalida / totalGeneral) * 100,
          ),
