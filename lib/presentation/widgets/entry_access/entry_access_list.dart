...
class EntryAccessList extends ConsumerStatefulWidget {
  final List<EntryAccessControl> items;
  final int? limit;

  const EntryAccessList({super.key, required this.items, this.limit = 15});

  @override
  ConsumerState<EntryAccessList> createState() => EntryAccessListState();
}

class EntryAccessListState extends ConsumerState<EntryAccessList> {
  ...
  @override
  void didUpdateWidget(EntryAccessList oldWidget) {
                ...
                itemBuilder: (context, index) {
                  ...
                  return Padding(
                    ...
                    child: InkWell(
                      ...
                      onTap: () =>
                        ModalHelper.open(context, child: EntryAccessDetailModal(item: item)),
                      child: Padding(
